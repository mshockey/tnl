...
final class Step_Contact extends Step {
	...
	protected function init() {
		...
		$fields = [
			...
			[
				...
				'value'       => wpem_get_contact_info( 'address' ),
				'default'     => '',
				'atts'        => [
	...
	public function content() {
		...
		if ( ! empty( $social_networks ) ) :
			...
			?>
			<p>
				<label><?php _e( 'Social Profiles', 'wp-easy-mode' ) ?></label>
				<br>
				<span class="description"><?php _e( 'Add links to the social profiles where website vistors can follow and learn more about you.', 'wp-easy-mode' ) ?></span>
				<br>
